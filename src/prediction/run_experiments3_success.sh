...
cat << 'EOF' > run_experiments3_success.py
import os
import json
import subprocess
...
output_file = "results_experiments3_success_update.json"
...
python run_experiments3_success.py

rm run_experiments3_success.py
