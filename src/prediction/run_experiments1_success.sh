...
cat << 'EOF' > run_experiments1_success.py
import os
import json
import subprocess
...
output_file = "results_experiments1_success.json"
data_path = "/Users/ajkunaseipi/Documents/MA4/PISA/data/robotarm_update.csv"
...
python run_experiments1_success.py

rm run_experiments1_success.py
